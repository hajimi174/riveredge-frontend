...
# 设置后端配置环境变量
export VITE_BACKEND_HOST="${VITE_BACKEND_HOST:-192.168.8.245}"
export VITE_BACKEND_PORT="${VITE_BACKEND_PORT:-8100}"
...
VITE_BACKEND_HOST="${VITE_BACKEND_HOST:-192.168.8.245}" \
VITE_BACKEND_PORT="${VITE_BACKEND_PORT:-8100}" \
